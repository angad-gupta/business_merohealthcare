...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        // $prescription_processing = Prescription::where('type','=','medicine')->where('status','=','processing')->get();
        // $prescription_completed = Prescription::where('type','=','medicine')->where('status','=','completed')->get();
...
//            fclose($fpbt);
    ...
    public function timerUpdate(Request $request)
    {
        ...
        if($request->company_name){
            $products = Product::where('company_name','=',$request->company_name)->get();
        }else{
            $products = Product::where('tags', 'like', '%' . $request->product_tag . '%')->get();
        }
        ...
        foreach($products as $product)
        {
            ...
            $product->sale_from = $request->sale_from;
            $product->sale_to = $request->sale_to;
            $product->update();
        }

        return redirect()->route('admin-timer-index')->with('success','Bulk Timer Updated Product Timer Status. '.count($products).' Product(s) Affected');
    }
