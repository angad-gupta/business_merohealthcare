...
Route::get('/gcat','FrontendController@getcategory');
  ...
  Route::post('upload-prescription-submit','FrontendController@uploadPrescription');
  ...
  Route::prefix('user')->group(function() {
    ...
    Route::group(['middleware'=>'verified'],function(){
      ...
      Route::post('/family/create', 'UserController@storeFamily')->name('user-family.store');
      ...
      Route::get('/prescriptionsfamily/create/{id}', 'UserController@uploadPrescriptionPagefamily')->name('user-prescriptions.family-create');
  ...
  Route::get('/private-policy','FrontendController@private_policy')->name('front.private_policy');
  ...
  Route::get('/payment/cancel', 'PaymentController@paycancel')->name('payment.cancle');
  Route::get('/payment/return', 'PaymentController@payreturn')->name('payment.return'); 
  ...
  Route::get('/human/verify','Auth\VerificationController@humanshow')->name('verification.humannotice');
