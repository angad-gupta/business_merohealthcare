...
Route::get('/gcat','FrontendController@getcategory');

Route::get('/others','FrontendController@others');
Route::post('/others/delete','FrontendController@othersdelete')->name('others.delete');
...
Route::get('/testing','FrontendController@testing');
  ...
  Route::get('vendor/order/notf', function() {
    return View::make('vendor_order_notf');
  });
  Route::get('product/notf', function() {
    return View::make('product_notf');
  });
  Route::get('vendorproduct/notf', function() {
    return View::make('vendor_product_notf');
  });
  ...
  // Route::get('/upload-business-order',function(){
  //   return view('front.uploadprescriptionbusiness');
  // })->middleware('guest:user');

  Route::get('/upload-prescription',function(){
    return view('front.uploadprescription');
  })->middleware('guest:user');

  Route::get('/upload-prescription/success',function(){
    return view('front.uploadprescriptionsuccess');
  })->middleware('guest:user');

  Route::get('/upload-business-prescription/success',function(){
    return view('front.uploadprescriptionsuccess');
  });

  Route::get('/askdoctor/index', 'FrontendController@askdoctorindex')->name('user-askdoctor-index');
  Route::get('/askdoctor/{id}/{slug}', 'FrontendController@askdoctorDoctorIndex')->name('user-askdoctor-doctor');
  Route::get('/askdoctor/index/{id}', 'FrontendController@askdoctorindexproduct')->name('user-askdoctor-index-product');
  Route::get('/askdoctor/success', 'FrontendController@askdoctorsuccess')->name('user-askdoctor-success');

  Route::post('/askdoctor/send', 'FrontendController@askdoctor')->name('user-askdoctor');
  Route::post('/askdoctor/product/send', 'FrontendController@askdoctorproduct')->name('user-askdoctor-product');

  Route::get('/uploadimage','FrontendController@showimage');

  Route::get('/provider/enqiury','FrontendController@providerenquiry')->name('provider-enquiry');
  Route::post('/provider/enqiury/send', 'FrontendController@providerenquirysend')->name('provider-enquiry-send');
  Route::get('/provider/enqiury/success','FrontendController@providerenquirysuccess')->name('provider-enquiry-success');

  // Route::get('/upload-prescription-business',function(){
  //   return view('front.uploadprescriptionbusiness');
  // })->middleware('guest:user');

  Route::post('/upload-prescription-fileupload','FrontendController@uploadPrescriptionfileupload')->name('prescription-multiple-files');
  Route::post('/upload-prescription-submit','FrontendController@uploadPrescription')->name('prescription-upload');


  Route::get('prescription/notf', function() {
    return View::make('prescription_notf');
  });

  Route::get('/upload-prescription-business','BusinessController@requestQuote')->name('business-quote');
  Route::post('/upload-prescription-business/store','BusinessController@store')->name('business-order');
  ...
  Route::get('/json/prescription/notf','Json\JsonRequestController@prescription_notf');
  Route::get('/json/prescription/notf/clear','Json\JsonRequestController@prescription_notf_clear');
  ...
  Route::get('/json/vendor/order/notf','Json\JsonRequestController@vendor_order_notf');
  Route::get('/json/vendor/order/notf/clear','Json\JsonRequestController@vendor_order_notf_clear');
  ...
  Route::get('/json/vendorproduct/notf','Json\JsonRequestController@vendor_product_notf');
  Route::get('/json/vendorproduct/notf/clear','Json\JsonRequestController@vendor_product_notf_clear');
  ...
  Route::get('/json/addnumcartBonus','Json\JsonRequestController@addnumcartBonus');
  ...
  Route::post('/json/transhow','Json\JsonRequestController@transhow');
  Route::get('/json/search','Json\JsonRequestController@search');
  Route::get('/json/mobilesuggest','Json\JsonRequestController@mobileSuggest');
  ...
  Route::prefix('admin')->group(function() {
    ...
    Route::get('/ask-doctor/index', 'AdminDoctorController@index')->name('admin-askdoctor-index');
    Route::get('/ask-doctor/queries', 'AdminDoctorController@queries')->name('admin-askdoctor-queries');
    Route::get('/ask-doctor/create', 'AdminDoctorController@create')->name('admin-askdoctor-create');
    Route::post('/ask-doctor/store', 'AdminDoctorController@store')->name('admin-askdoctor-store');
    Route::get('/ask-doctor/{id}/edit', 'AdminDoctorController@edit')->name('admin-askdoctor-edit');
    Route::post('/ask-doctor/{id}/update', 'AdminDoctorController@update')->name('admin-askdoctor-update');
    Route::get('/ask-doctor/{id}/delete', 'AdminDoctorController@destroy')->name('admin-askdoctor-destroy');
    Route::get('/ask-doctor/status/{id1}/{id2}', 'AdminDoctorController@status')->name('admin-askdoctor-status');

    Route::get('/bulk-timer', 'AdminController@timer')->name('admin-timer-index');
    Route::post('/bulk-timer/update', 'AdminController@timerUpdate')->name('admin-timer-store');
    ...
    Route::post('/advertise/store', 'AdvertiseController@store')->name('admin-adv-store');
    Route::get('/advertise/edit/{id}', 'AdvertiseController@edit')->name('admin-adv-edit');
    Route::post('/advertise/update/{id}', 'AdvertiseController@update')->name('admin-adv-update');
    Route::get('/advertise/delete/{id}', 'AdvertiseController@destroy')->name('admin-adv-delete');
    Route::get('/advertise/status/{id1}/{id2}', 'AdvertiseController@status')->name('admin-adv-status');
    ...
    Route::get('/orders/cancellation', 'AdminOrderController@requestCancellation')->name('admin-order-cancellation');
    ...
    Route::get('/order/{id}/print/details', 'AdminOrderController@printpagedetails')->name('admin-order-print-details');
    ...
    Route::post('/order/{id}/delivery', 'AdminOrderController@delivery')->name('admin-order-delivery');

    Route::get('/buisnessprescriptions', 'AdminBusinessOrderController@index')->name('admin-business-prescriptions-index');
    Route::get('/buisnessprescriptions/{id}/show', 'AdminBusinessOrderController@show')->name('admin-business-prescription-show');
    Route::get('/buisnessprescriptions/{id}/invoice', 'AdminBusinessOrderController@invoice')->name('admin-business-prescription-invoice');
    Route::post('/buisnessprescriptions/{id}/invoice', 'AdminBusinessOrderController@saveInvoice');

    Route::get('/buisnesscustomers', 'AdminBusinessOrderController@businessindex')->name('admin-business-customer-index');
    Route::get('/buisnesscustomers/verify/{id}', 'AdminBusinessOrderController@businessCustomerVerify')->name('admin-business-customer-verify');

    Route::get('/product/vendor/verify/{id}', 'AdminVendorController@productVendorVerify')->name('admin-product-vendor-verify');
    Route::get('/lab/vendor/verify/{id}', 'AdminVendorController@labVendorVerify')->name('admin-lab-vendor-verify');

    Route::get('/buisnessprescriptions/{id}/status/{status}', 'AdminBusinessOrderController@status')->name('admin-business-prescription-status');
    Route::get('/businessorders/{id}/file/{name}/{bfid}', 'AdminBusinessOrderController@getBusinessorderFile')->name('admin-businessorder-file');
    Route::get('/precriptionorders/{id}/file/{name}/{pfid}', 'AdminOrderController@getPrescriptionOrderFile')->name('admin-prescriptionorder-file');

    Route::get('/businessorders/{id}/file/{name}', 'AdminBusinessOrderController@getBusinessorderRegFile')->name('admin-businessorder-reg-file');
    Route::get('/businesscustomers/{id}/file/{name}', 'AdminBusinessOrderController@getBusinessCustomerRegFile')->name('admin-businesscustomer-reg-file');

    Route::get('/product/vendor/{id}/file/{name}', 'AdminVendorController@getProductVendorRegFile')->name('admin-product-vendor-reg-file');
    Route::get('/lab/vendor/{id}/file/{name}', 'AdminVendorController@getLabVendorRegFile')->name('admin-lab-vendor-reg-file');

    Route::get('/prescriptions', 'AdminPrescriptionController@index')->name('admin-prescriptions-index');
    Route::get('/prescriptions/{id}/show', 'AdminPrescriptionController@show')->name('admin-prescription-show');
    Route::get('/prescriptions/{id}/invoice', 'AdminPrescriptionController@invoice')->name('admin-prescription-invoice');
    Route::post('/prescriptions/{id}/invoice', 'AdminPrescriptionController@saveInvoice');

    Route::get('/lab/prescriptions', 'AdminPrescriptionController@labindex')->name('admin-prescriptions-lab-index');
    Route::get('/lab/prescriptions/{id}/show', 'AdminPrescriptionController@labshow')->name('admin-prescription-lab-show');
    Route::post('/lab/prescriptions/{id}/invoice', 'AdminPrescriptionController@saveLabInvoice')->name('admin-prescription-lab-invoice');

    Route::get('/prescriptions/{id}/file/{name}/{pfid}', 'AdminPrescriptionController@getPrescriptionFile')->name('admin-prescription-file');
    Route::get('/prescriptions/{id}/status/{status}', 'AdminPrescriptionController@status')->name('admin-prescription-status');
    Route::post('/prescriptions/email/', 'AdminPrescriptionController@emailsub')->name('admin-prescriptions-emailsub');

    Route::get('/users/birthday', 'AdminUserController@birthday')->name('admin-user-birthday');
    Route::get('/users', 'AdminUserController@index')->name('admin-user-index');

    Route::get('/users/native', 'AdminUserController@nativeCustomer')->name('admin-user-native');
    Route::get('/users/social', 'AdminUserController@socialCustomer')->name('admin-user-social');
    Route::get('/users/guest', 'AdminUserController@guestCustomer')->name('admin-user-guest');
    ...
    Route::get('/product/vendor', 'ProductController@vendorindex')->name('admin-vendor-prod-index');
    Route::get('/product/search', 'ProductController@productsearch')->name('admin-prod-search');

    Route::get('/product/childcategory/search', 'ProductController@childcategorysearch')->name('admin-prod-childcategory-search');
    Route::get('/product/search/price-range', 'ProductController@productPriceRangeSearch')->name('admin-prod-price-range-search');
    Route::get('/order/search', 'AdminOrderController@ordersearch')->name('admin-order-search');
    Route::get('/product/vendor/search', 'ProductController@vendorproductsearch')->name('admin-vendor-prod-search');

    Route::get('/product/approval', 'ProductController@approval')->name('admin-prod-approval');
    ...
    Route::get('/product/stock', 'ProductController@stock')->name('admin-prod-stock');
    Route::post('/product/create', 'ProductController@store')->name('admin-prod-store');

    Route::get('/product/import', 'ProductController@import')->name('admin-prod-import');
    Route::get('/product/export','ProductController@export')->name('admin-prod-export');
    Route::post('/product/import','ProductController@upload');
    ...
    Route::get('/product/myproductsDeleteAll', 'ProductController@deleteAll')->name('admin-prod-delete-all');
    Route::get('/product/duplicate/{id}', 'ProductController@duplicate')->name('admin-prod-duplicate');
    Route::get('/product/multiplestatus', 'ProductController@multiplestatus')->name('admin-prod-multiplestatus');
    Route::get('/product/categorychange', 'ProductController@categorychange')->name('admin-prod-category-change');

    Route::get('promotions/{id}/status/change/{status}', 'PromotionController@status')->name('promotions.status');
    ...
    Route::get('/blog/file/{id}', 'AdminBlogController@fileshow')->name('blog-file');

    Route::get('/offers', 'FrontendController@offersindex')->name('admin-offers');
    Route::get('/offers/create', 'FrontendController@offerscreate')->name('admin-offers-create');
    Route::post('/offers/store', 'FrontendController@offersstore')->name('admin-offers-store');
    Route::get('/offers/edit/{id}', 'FrontendController@offersedit')->name('admin-offers-edit');
    Route::post('/offers/update/{id}', 'FrontendController@offersupdate')->name('admin-offers-update');
    Route::get('/offers/delete/{id}', 'FrontendController@offersdelete')->name('admin-offers-delete');
    ...
    Route::group(['middleware'=>'admininistrator'],function(){
      ...
      Route::get('/product/vendors/verify', 'AdminVendorController@vendorverifyindex')->name('admin-product-vendor-index');
      Route::get('/lab/vendors/verify', 'AdminVendorController@labverifyindex')->name('admin-lab-vendor-index');
      Route::get('/vendors/enquiry/index', 'AdminVendorController@enquiryindex')->name('admin-vendor-enquiry-index');
      Route::get('/vendors/enquiry/{id}/detail', 'AdminVendorController@enquirydetail')->name('admin-vendor-enquiry-detail');
      ...
      Route::get('/career/descriptions', 'CareerController@descriptions')->name('admin-career-descriptions');
      Route::post('/career/descriptions/post/{id}', 'CareerController@descriptionspost')->name('admin-career-descriptions-post');
      Route::post('/career/hirings/post/{id}', 'CareerController@hiringspost')->name('admin-career-hirings-post');



      Route::get('/career/openings/index', 'CareerController@openingsindex')->name('admin-career-openings-index');
      Route::get('/career/openings/create', 'CareerController@openingscreate')->name('admin-career-openings-create');
      Route::post('/career/openings/create/new', 'CareerController@openingscreatenew')->name('admin-career-openings-create-new');
      Route::get('/career/openings/delete/{id}', 'CareerController@openingsdelete')->name('admin-career-openings-delete');
      Route::get('/career/openings/post/{id}', 'CareerController@openingsedit')->name('admin-career-openings-edit');
      Route::post('/career/openings/post/update/{id}', 'CareerController@openingseditupdate')->name('admin-career-openings-edit-update');

      Route::post('/career/candidates/submit', 'CareerController@candidatesubmit')->name('admin-career-candidates-submit');
      Route::get('/career/candidates/delete/{id}', 'CareerController@candidatesdelete')->name('admin-career-candidates-delete');

      Route::get('/career/candidates/file/{id}', 'CareerController@candidatefile')->name('candidate-file');


      Route::get('/career/candidates', 'CareerController@candidates')->name('admin-career-candidates');

      Route::get('/career/candidates/detail/{id}', 'CareerController@candidatesdetail')->name('admin-career-candidates-detail');
  ...
  Route::prefix('user')->group(function() {
    Route::post('/password/email','Auth\ForgotPasswordController@sendResetLinkEmail')->name('user-forgot-submit');
    Route::post('/password/reset','Auth\ResetPasswordController@reset')->name('password.update');
    Route::get('/password/reset','Auth\ForgotPasswordController@showLinkRequestForm')->name('user-forgot');
    ...
    Route::get('/businesslogin', 'Auth\UserLoginController@showBusinessLoginForm')->name('business-login');
    Route::post('/businesslogin', 'Auth\UserLoginController@businesslogin')->name('business-login-submit');
    Route::get('/businessregister', 'Auth\UserRegisterController@showBusinessRegisterForm')->name('business-register');
    Route::post('/businessregister', 'Auth\UserRegisterController@businessregister')->name('business-register-submit');

    Route::get('/vendor/login', 'Auth\UserLoginController@showVendorLoginForm')->name('vendor-login');
    Route::post('/vendor/login', 'Auth\UserLoginController@vendorlogin')->name('vendor-login-submit');
    Route::get('/vendor/register', 'Auth\UserRegisterController@showVendorRegisterForm')->name('vendor-register');
    Route::post('/vendor/register', 'Auth\UserRegisterController@vendorregister')->name('vendor-register-submit');

    Route::get('/product/vendor/login', 'Auth\UserLoginController@showProductVendorLoginForm')->name('product-vendor-login');
    Route::post('/product/vendor/login', 'Auth\UserLoginController@productVendorLogin')->name('product-vendor-login-submit');
    // Route::get('/product/vendor/register', 'Auth\UserRegisterController@showProductVendorRegisterForm')->name('product-vendor-register');
    Route::post('/product/vendor/register', 'Auth\UserRegisterController@productvendorregister')->name('product-vendor-register-submit');
    ...
    Route::group(['middleware'=>'verified'],function(){
      ...
      Route::get('/family', 'UserController@family')->name('user-family.index');
      Route::get('/family/create', 'UserController@createFamily')->name('user-family.create');
      Route::post('/family/store', 'UserController@storeFamily')->name('user-family.store');
      Route::post('/family/createmany', 'UserController@storeManyFamily')->name('user-family.storemany');
      Route::get('/family/{id}/edit', 'UserController@editFamily')->name('user-family.edit');
      Route::post('/family/{id}/update', 'UserController@updateFamily')->name('user-family.update');
      Route::post('/family/{id}/delete', 'UserController@deleteFamily')->name('user-family.delete');

      Route::post('/prescriptions/family', 'UserController@getfamilyprescriptions')->name('user-prescriptions.family');
      Route::get('/prescriptions/family/{id}/filter', 'UserController@getfamilyfilterprescriptions')->name('user-prescriptions.family-filter');
      Route::get('/prescriptions/family/{id}/filefilter', 'UserController@getfamilyfilterfile')->name('user-prescriptions.family-file-filter');

      Route::get('/prescriptions', 'UserController@prescriptions')->name('user-prescriptions.index');
      Route::get('/lab/prescriptions', 'UserController@labprescriptions')->name('user-lab-prescriptions.index');
      Route::get('/businessorders', 'UserController@businessorders')->name('user-businessorders.index');
      Route::get('/prescriptions/create', 'UserController@uploadPrescriptionPage')->name('user-prescriptions.create');
      Route::get('/prescriptions/create/{id}', 'UserController@uploadPrescriptionPagefamily')->name('user-prescriptions.family-create');

      Route::get('/lab/prescriptions/direct', 'UserController@labtestredirect')->name('user-labtest-redirect');

      Route::get('/vendor/product', 'VendorProductController@index')->name('user-vendor-product.index');
      Route::get('/vendor/product/create', 'VendorProductController@create')->name('user-vendor-prod-create');
      Route::post('/vendor/product/store', 'VendorProductController@store')->name('user-vendor-prod-store');
      Route::get('/vendor/product/edit/{id}', 'VendorProductController@edit')->name('user-vendor-prod-edit');
      Route::post('/vendor/product/update/{id}', 'VendorProductController@update')->name('user-vendor-prod-update');
      Route::get('/vendor/product/delete/{id}', 'VendorProductController@destroy')->name('user-vendor-prod-delete');

      Route::get('/vendor/product/search', 'VendorProductController@productsearch')->name('user-vendor-prod-search');
      Route::get('/vendor/product/myproductsDeleteAll', 'VendorProductController@deleteAll')->name('user-vendor-prod-delete-all');
      Route::get('/vendor/product/multiplestatus', 'VendorProductController@multiplestatus')->name('user-vendor-prod-multiplestatus');


      Route::post('/prescriptions/update/{id}', 'UserController@updatePrescriptionstatus')->name('user-prescriptions.update-status');
      Route::post('/businessorderstatus/update/{id}', 'UserController@updateBusinessorderstatus')->name('user-businessorder.update-status');

      Route::post('/prescriptions', 'UserController@uploadPrescription')->name('user-prescriptions.store');
      Route::post('/prescriptions/{id}/fileupload/', 'UserController@uploadPrescriptionFile')->name('user-prescriptions.filestore');
      Route::post('/prescriptions/{id}/fileuploadfamily/{fid}', 'UserController@uploadPrescriptionFamilyFile')->name('user-prescriptions.filestorefamily');
      Route::post('/prescriptions/{id}/fileuploadfamilysingle/', 'UserController@uploadPrescriptionFamilyFileSingle')->name('user-prescriptions.filestorefamilysingle');
      // Route::get('/prescriptions/{id}/reorder', 'UserController@prescriptionReorderPage')->name('user-prescriptions.reorder');
      Route::post('/prescriptions/{id}/reorder', 'UserController@prescriptionReorder')->name('user-prescriptions.reorder');
      Route::post('/lab/prescriptions/{id}/reorder', 'UserController@labprescriptionReorder')->name('user-labprescriptions.reorder');
      Route::get('/prescriptions/{id}/invoice', 'UserController@prescriptionInvoice')->name('user-prescriptions.invoice');
      Route::get('/prescriptions/{id}/file/{name}/{pfid}', 'UserController@getPrescriptionFile')->name('user-prescriptions.file');
      Route::get('/businessorders/{id}/file/{name}/{pfid}', 'BusinessController@getBusinessorderFile')->name('user-businessorders.file');
      Route::get('/fileupload/{id}', 'UserController@getFile')->name('user-file');

      Route::post('/prescriptions/{id}/reminder/add', 'UserController@prescriptionReminderAdd')->name('user-prescriptions.addreminder');
      Route::post('/prescriptions/{id}/reminder/edit', 'UserController@prescriptionReminderUpdate')->name('user-prescriptions.editreminder');
      Route::post('/prescriptions/{id}/reminder/delete', 'UserController@prescriptionReminderDelete')->name('user-prescriptions.deletereminder');

      Route::get('/wishlist', 'UserController@wishlists')->name('user-wishlist');
      Route::get('/filemanager', 'UserController@filemanager')->name('user-filemanager');
      Route::post('/filemanager/{id}/fileupdate', 'UserController@updatefilemanager')->name('user-filemanagerupdate');
      Route::post('/filemanager/{id}/fileupdatesingle', 'UserController@updatefilemanagersingle')->name('user-filemanagerupdatesingle');
      Route::post('/filemanager/{id}/filetitleupdate', 'UserController@updatefilemanagertitle')->name('user-filemanagertitleupdate');
      Route::post('/filemanager/{id}/filetitleupdatesingle', 'UserController@updatefilemanagertitlesingle')->name('user-filemanagertitleupdatesingle');
      ...
      Route::post('/profile/image_delete', 'UserController@profile_delete_image')->name('user-profile-image-delete');
      ...
      Route::post('/order/{id}/cancellation', 'UserController@requestCancellation')->name('user-order.cancellation');
      ...
      Route::get('/paypal/cancel', 'SubscribePaypalController@paycancel')->name('user.payment.cancle');
      ...
      Route::prefix('vendor')->group(function() {
        ...
        Route::group(['middleware'=>'vendor'],function(){
          ...
          Route::get('/settings/', 'UserController@settings')->name('user-service-location');
          Route::post('/settings/', 'UserController@settingsUpdate');
          Route::get('/settings/vendor_description', 'UserController@settings_vendor_description')->name('user-vendor-description');
          Route::post('/settings/vendor_description/create', 'UserController@settings_vendor_description_create')->name('user-vendor-description-create');
          Route::post('/settings/vendor_description/update/{id}', 'UserController@settings_vendor_description_update')->name('user-vendor-description-update');
  ...
  Route::get('/privacy-policy','FrontendController@private_policy')->name('front.private_policy');
  ...
  Route::get('/blog/{slug}','FrontendController@blogshow')->name('front.blogshow');
  ...
  Route::post('/payment', 'PaymentController@store')->name('payment.submit');
  Route::get('/checkout/{order_number}/payment', 'PaymentController@payment')->name('payment.pay');

  Route::post('/checkout/{order_number}/gateway/bank', 'PaymentController@payWithBank');
  Route::post('/checkout/{order_number}/gateway/cod', 'PaymentController@cashondelivery');
  Route::post('/checkout/{order_number}/gateway/khalti', 'PaymentController@payWithKhalti');
  Route::post('/checkout/{order_number}/gateway/fonepay', 'PaymentController@payWithFonePay');
  Route::post('/checkout/{order_number}/gateway/esewa', 'PaymentController@payWithEsewa');
  Route::post('/checkout/{order_number}/gateway/imepay', 'PaymentController@payWithIMEPay');
  Route::post('/checkout/{order_number}/gateway/ipay', 'PaymentController@payWithIPay');
  Route::post('/checkout/{order_number}/gateway/card', 'PaymentController@payWithCard');

  Route::post('checkout/khalti/verify','PaymentController@khaltiVerification');
  Route::get('checkout/{order_number}/fonepay/verify','PaymentController@verifyFonePay')->name('payment.verify_fonepay');
  Route::post('checkout/imepay/verify','PaymentController@verifyIMEPay')->name('payment.verify_imepay');
  Route::get('checkout/{order_number}/esewa/verify','PaymentController@verifyEsewa')->name('payment.verify_esewa');
  Route::post('checkout/{order_number}/ipay/verify','PaymentController@verifyIpay')->name('payment.verify_ipay');
  Route::post('checkout/card/verify','PaymentController@verifyCard')->name('payment.verify_card');
  Route::post('checkout/card/cancel','PaymentController@cancelCard')->name('payment.cancel_card');
  ...
  Route::get('/askdoctor/refresh_code','FrontendController@ask_doctor_refresh_code');
  Route::post('/vendor/registration', 'FrontendController@vendor_register')->name('vendor.registration');
  Route::get('/vendor/{slug}', 'VendorFrontController@vendor')->name('front.vendor');
  Route::get('/vendor/{slug}/{sort}','VendorFrontController@vendorsort');


  Route::get('/vendor/{slug1}/category/{slug2}','VendorFrontController@vendorcategory')->name('front.vendor.category');
  Route::get('/vendor/{slug1}/category/{slug2}/{sort}','VendorFrontController@vendorcategorysort');


  Route::get('/vendor/{slug1}/subcategory/{slug2}','VendorFrontController@vendorsubcategory')->name('front.vendor.subcategory');
  Route::get('/vendor/{slug1}/subcategory/{slug2}/{sort}','VendorFrontController@vendorsubcategorysort');


  Route::get('/vendor/{slug1}/childcategory/{slug2}','VendorFrontController@vendorchildcategory')->name('front.vendor.childcategory');
  Route::get('/vendor/{slug1}/childcategory/{slug2}/{sort}','VendorFrontController@vendorchildcategorysort');

  Route::get('auth/{provider}', 'Auth\SocialRegisterController@redirectToProvider')->name('social-provider');
  Route::get('signin/{provider}/callback', 'Auth\SocialRegisterController@handleProviderCallback');

  Route::get('/email/verify','Auth\VerificationController@show')->name('verification.notice');
  Route::get('/registration_certificate/verify','Auth\VerificationController@humanshow')->name('verification.humannotice');
    Route::get('/email/resend','Auth\VerificationController@resend')->name('verification.resend');
    Route::get('/email/verify/{code}','Auth\VerificationController@verify')->name('verification.verify');

  Route::get('/promotions','FrontendController@promotions')->name('front.promotions');
  Route::get('/discount-offers','FrontendController@discountOffers')->name('front.discount.offers');
  Route::get('/career','FrontendController@career')->name('front.career');
  Route::get('/return-and-refund-policy','FrontendController@refundpolicy')->name('front.refundpolicy');
  Route::get('/sell-on-merohealthcare','FrontendController@sellOnMhc')->name('front.sell-on-mhc');
  // Route::get('/lab','FrontendController@test');
