                                        ...
                                        <div class="row reorder-xs">
                                            <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Order Invoice <a href="{{ url()->previous()}}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a>  <a class="btn  add-newProduct-btn print" href="{{route('user-lab-order-print',$order->id)}}" target="_blank" style="padding: 5px 12px;"><i class="fa fa-print"></i> Print Invoice</a></h2>
                                                ...
                                                <div class="row reorder-xs">
                                                    <div class="col-sm-6">
                                                        <div class="container text-center">
                                                            <img class="text-center" src="{{url('assets/images/logo.jpg')}}" style="height:100px; width:175px; text-align:right;"/>
                                                            </div>
                                                    </div>
