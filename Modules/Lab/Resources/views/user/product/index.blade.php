...
@section('title','Lab Tests/Products')
                                  ...
                                  <tbody>
                                    @foreach($prods as $prod)    
                                        <tr>
                                          ...
                                          <td>{{ $prod->type->name }}<small style="display: block; color: #777;">ID: {{sprintf("%'.08d", $prod->id)}}</small></td>
                                          ...
                                          <td>                                         
                                            <span class="dropdown">
                                              ...
                                              <ul class="dropdown-menu">
                                                  <li><a href="{{route('user-lab-prod-st',['id1'=>$prod->id,'id2'=>1])}}">Active</a></li>
                                                  <li><a href="{{route('user-lab-prod-st',['id1'=>$prod->id,'id2'=>0])}}">Deactive</a></li>
                                              </ul>
                                            </span>
                                          </td>
                                          <td>

                                            <a href="{{route('user-lab-prod-edit',$prod->id)}}" class="btn btn-primary product-btn"><i class="fa fa-edit"></i> Edit</a>
                                            ...
                                            <a href="javascript:;" data-href="{{route('user-lab-prod-delete',$prod->id)}}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger product-btn"><i class="fa fa-trash"></i></a>
                                          </td>
                                        </tr>
                                    @endforeach
                                  </tbody>
  ...
  <script type="text/javascript">
    ...
    $( document ).ready(function() {
      $(".add-button").append('<div class="col-sm-4 add-product-btn text-right">'+
        '<a href="{{route('user-lab-prod-create')}}" class="add-newProduct-btn">'+
