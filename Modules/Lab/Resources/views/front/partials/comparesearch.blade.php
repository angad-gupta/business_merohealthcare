  ...
  {{--                             
                          ...
                          <ul class="list-inline g-mb-10 text-center">
                            ...
                            <li class="list-inline-item ">
                              ...
                              <button style="border-radius:30px;line-height:1; padding:0.57143rem 0.82857rem;" class="btn btn-md u-btn-primary g-font-weight-600 g-font-size-11 text-uppercase addTestsCart">
                                  <i class="icon-note"></i>
                                  Book Now
                              </button>
