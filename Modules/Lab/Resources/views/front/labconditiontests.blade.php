...
@section('title','Lab Conditions Tests')
    ...
    <div class="row justify-content-between">
      <div class="col-lg-9 order-lg-2 g-mb-80">
        ...
        <div class="container g-mt-5">
         ...
         <ul class="breadcrumbs" style="margin-top: 10px;">
            ...
            <li class="last active"><a href="#"> Test For {{$cond[0]}}</a></li>
        </ul>
      ...
      <div class="col-lg-3 order-lg-1 g-brd-right--lg g-brd-gray-light-v4 g-mb-80">
        <div class="container" style="">
          <!-- Links -->
          <div class="g-mb-5">
            <h4 class="h6 g-font-weight-700 g-mb-10 g-mt-0">Test By Conditions:</h4>
            <select id="mounth" class="form-control" onChange="window.location.href=this.value">
                <option value="hide">Search by Condition</option>
                @foreach($labconditions as $c)
                <option value="/lab/condition/{{$c->condition_slug}}" rel="icon-temperature" >{{$c->condition_name}} ({{$c->products->count()}})</option>
