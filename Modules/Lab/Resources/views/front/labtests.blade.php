    ...
    <div class="row justify-content-between">
      <div class="col-lg-9 order-lg-2 g-mb-80">
        ...
        <div class="container g-mt-5">
         ...
         <ul class="breadcrumbs" style="margin-top: 10px;">
            ...
            <li class="last active"><a href="#"> Test For {{$cat[0]}}</a></li>

            {{-- <button class="btn btn-primary pull-right" style="border-radius:30px;" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
         ...
         {{-- <ul class="u-list-inline g-mb-10">
          ...
          <li class="list-inline-item g-mr-7">
            <a class="u-link-v5 g-color-primary--hover" style="color:#555;" href="#">Available Test</a>
          </li>
          ...
          <ul class="nav u-nav-v2-1 u-nav-primary g-mb-20" role="tablist" data-target="nav-2-1-primary-hor-left" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-primary g-mb-20">
            ...
            @foreach($cats->slice(0, 3) as $c)
            <li class="nav-item" style="margin-top:5px;margin-bottom:5px;">
              <a class="nav-link {{$loop->index==0?'active':''}}" data-toggle="tab" href="#{{$c->id}}" role="tab" style="border-radius: 30px; padding: 2px 10px;margin: 0px 5px;"> {{$c->name}}</a>
            </li>
          @endforeach
          <div class="pull-right">
            <button class="btn btn-primary pull-right" style="border-radius:30px;margin-top:5px;padding:3px 10px; margin-right:5px;" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
              .....
              </button>
            </div>
          <div class="pull-right">
          <button class="btn btn-primary pull-right" style="border-radius:30px;margin-top:5px;padding:3px 10px;" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
            <i class="icon-size-fullscreen"></i>
            </button>
          </div>
        </ul>
                  ...
                  <div class="tab-pane fade {{$loop->index==0?'show active':''}}" id="{{$c->id}}" role="tabpanel">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 col-lg-6 g-mb-30">
                            ...
                            <article class="u-shadow-v19 media g-bg-white rounded g-pa-20"><div class="media-body">
                                <div class="g-mb-10">
                                  <h3 class="h5 g-mb-5">
                                ...
                                <ul class="list-inline text-center" style="margin-bottom: 0rem;font-size:14px;">
                                  ...
                                  <div class=" g-font-size-12 g-brd-gray-light-v4 g-pa-15-20 text-center" >
                                    <input type="hidden" value="{{ $product->id }}" />
                                  <button class="btn btn-md u-btn-orange g-font-weight-600 g-font-size-11 text-uppercase" style="border-radius:30px;line-height:1; padding:0.57143rem 0.82857rem;" data-toggle="modal" data-target="#testdetails{{$c->id}}">
                      ...
                      <div class="modal fade" id="testdetails{{$c->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">{{$product->vendor->name}}</h5>
      ...
      <div class="col-lg-3 order-lg-1 g-brd-right--lg g-brd-gray-light-v4 g-mb-80">
        <div class="g-pr-1--lg">
          ...
          <div class="g-mb-5">
            <h4 class="h6 g-font-weight-700 g-mb-10 g-mt-0">Test By Categories:</h4>
            <select id="mounth" class="form-control" onChange="window.location.href=this.value">
                <option value="hide">Search by Categories</option>
                @foreach($labcategories as $c)
                <option value="/lab/category/{{$c->cat_slug}}" rel="icon-temperature" >{{$c->cat_name}} ({{$c->products->count()}})</option>
                
                @endforeach
            </select> 

            <h4 class="h6 g-font-weight-700 g-mb-10 g-mt-0">Filter By:</h4>
