              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="add-product-box">
                          ...
                          <div class="row reorder-xs">
                              <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                  <div class="product-header-title">
                                      <h2>Add Category <a href="{{ route('lab-cat-index') }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a></h2>
                      ...
                      <hr>
                      <form class="form-horizontal" action="{{route('lab-cat-store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input class="form-control" name="cat_slug" id="blood_group_slug" placeholder="Enter Category Slug eg. blood-test" required="" type="text" >
                          </div>
                        </div>
