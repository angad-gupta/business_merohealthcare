                                                                    ...
                                                                    <td>
                                                                        <span class="dropdown">
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                <li><a href="{{route('lab-cat-st',['id1'=>$cat->id,'id2'=>1])}}">Active</a></li>
                                                                                <li><a href="{{route('lab-cat-st',['id1'=>$cat->id,'id2'=>0])}}">Deactive</a></li>
                                                                            </ul>
                                                                        </span>
                                                                    </td>
                                                                    <td>
                                                                        <a href="{{route('lab-cat-edit',$cat->id)}}" class="btn btn-primary product-btn"><i class="fa fa-edit"></i> Edit</a>
                                                                        <a href="javascript:;" data-href="{{route('lab-cat-delete',$cat->id)}}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Remove</a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
...
<script type="text/javascript">
    ...
    $( document ).ready(function() {
        $(".add-button").append('<div class="col-sm-4 add-product-btn text-right">'+
          '<a href="{{route('lab-cat-create')}}" class="add-newProduct-btn">'+
