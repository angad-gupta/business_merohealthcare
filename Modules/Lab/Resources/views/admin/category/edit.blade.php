                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="add-product-box">
                              ...
                              <div class="row reorder-xs">
                                  <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                      <div class="product-header-title">
                                          <h2>Update Category <a href="{{ route('lab-cat-index') }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a></h2>
                          ...
                          <hr>
                          <form class="form-horizontal" action="{{route('lab-cat-update',$cat->id)}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                <input class="form-control" name="cat_slug" id="edit_blood_group_slug" placeholder="Enter Category Slug eg. blood-test"  required="" type="text" value="{{$cat->cat_slug}}" >
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                <img width="130px" height="90px" id="adminimg" src="{{ $cat->photo ? asset('assets/images/'.$cat->photo):'http://fulldubai.com/SiteImages/user.png'}}" alt="" id="adminimg">
                              </div>
                            </div>
                            <div class="form-group">
