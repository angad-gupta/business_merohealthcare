              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="add-product-box">
                          ...
                          <div class="row reorder-xs">
                              <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                  <div class="product-header-title">
                                      <h2>Add Speciality <a href="{{ route('lab-speciality-index') }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a></h2>
                                      <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Manage Speciality <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Main Speciality <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Add
                                  </div>
                              </div>
                      ...
                      <hr>
                      <form class="form-horizontal" action="{{route('lab-speciality-store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input class="form-control" name="speciality_name" id="blood_group_display_name" placeholder="Enter Speciality name" required="" type="text" >
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-sm-4" for="blood_group_slug">Slug* <span>(In English)</span></label>
                          <div class="col-sm-6">
                            <input class="form-control" name="speciality_slug" id="blood_group_slug" placeholder="Enter Speciality Slug eg. haemoglobin-test" required="" type="text" >
                          </div>
                        </div>
