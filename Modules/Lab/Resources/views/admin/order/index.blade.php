                                                        ...
                                                        <tbody>
                                                            @foreach($orders as $order)                                                  
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> <a href="{{route('lab-order-invoice',$order->id)}}">{{sprintf("%'.08d", $order->id)}}</a></td>
                                                                    <td> {{$order->totalQty}}</td>
                                                                    <td> {{$order->currency_sign}}{{ round($order->pay_amount * $order->currency_value , 2) }}</td>
                                                                    <td> {{$order->method}}</td>
                                                                    <td>
                                                                        <input type="hidden" value="{{$order->customer_email}}">
                                                                        <a href="{{route('lab-order-show',$order->id)}}" class="btn btn-primary product-btn"><i class="fa fa-check"></i> View Details</a>
                                                                        ...
                                                                        <span class="dropdown">
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                <li><a href="javascript:;" data-href="{{route('lab-order-status',['id1' => $order->id, 'status' => 'processing'])}}" data-toggle="modal" data-target="#confirm-delete">Processing</a></li>
                                                                                <li><a href="javascript:;" data-href="{{route('lab-order-status',['id1' => $order->id, 'status' => 'completed'])}}" data-toggle="modal" data-target="#confirm-delete">Completed</a></li>
                                                                                <li><a href="javascript:;" data-href="{{route('lab-order-status',['id1' => $order->id, 'status' => 'declined'])}}" data-toggle="modal" data-target="#confirm-delete">Declined</a></li>
                                                                            </ul>
                                                                        </span>
                                                                    </td>
                                                                </tr>
