...
class JsonRequestController extends Controller
{
    ...
    public function compare(Request $request)
    {
        ...
        $data = view('lab::front.partials.compare')->with('cats',$products)->with('vendors',$vendors)->with('vendor_products',$vendor_products)->with('curr',$curr)->with('gs',$gs)->render();
    ...
    public function testdetail(Request $request){
        ...
        $products = LabProduct::whereIn('id',$ids)->where('status',1)->get();
        $data = view('lab::front.partials.testdetail')->with('prods',$products)->render();
        return response()->json($data);  
    }
    ...
    public function comparesearch(Request $request)
    {
        ...
        $data = view('lab::front.partials.comparesearch')->with('cats',$products)->with('vendors',$vendors)->with('vendor_products',$vendor_products)->with('curr',$curr)->with('gs',$gs)->render();
