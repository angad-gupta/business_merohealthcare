      ...
      <div class="container-fluid">
        ...
        <div class="singleCompare__content-wrap">
          ...
          <div class="singleCompare__content">
            ...
            <p><strong><a style="color: black;" href="{{ route('front.product',[$product['item']['id'],str_slug($product['item']['name'],'-')]) }}">{{strlen($product['item']['name']) > 70 ? substr($product['item']['name'],0,70).'...' : $product['item']['name']}}</a></strong></p>
            <p>                              @if($gs->sign == 0)
