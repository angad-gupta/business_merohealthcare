...
@section('body')
    ...
    <div style="font-size: 14px; font-weight: 400; line-height: 24px; color: #333333;">
        ...
        <p>The password for you Merohealthcare has been changed. You have currently been log out from all your devices. Please use your new password to log in back to Merohealthcare. </p>
