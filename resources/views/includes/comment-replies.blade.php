    ...
    <div class="container pt-50">
      <div class="row">
        <div class="col-lg-12">
          <div class="blog-comments-area product">
            <hr>
            <h3 class="text-center"><a style="color:white;cursor: pointer; background-color: {{$gs->colors == null ? '#007bff':$gs->colors}}; border-color: {{$gs->colors == null ? '#007bff':$gs->colors}}; padding: 8px 12px;"  class="no-wish btn btn-primary" data-toggle="modal" data-target="#loginModal">{{$lang->comment_login}}</a> {{$lang->comment_review}} </h3>
            <hr>
          </div>
        </div>
      </div>
