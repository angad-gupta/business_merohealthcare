...
@section('title','Lab Service Provider Login')
@section('content')
...
/* body{
  background: url('https://www.colourbox.com/preview/11433693-abstract-molecules-medical-background.jpg');
        ...
        <div class="container">
          ...
          <div class="login-tab">
            <ul class="nav nav-tabs">
              ...
              {{-- <li class="active"><a data-toggle="tab" href="#login" style="font-size:15px;">Lab Vendor Login</a></li> --}}
              <li class="active"><a data-toggle="tab" href="#signup" style="font-size:15px;">Lab Vendor Register</a></li>
                  ...
                  <div class="form-group {{$lang->rtl == 1 ? 'text-right' : ''}}">
                    ...
                    <div class="form-group {{$lang->rtl == 1 ? 'text-right' : ''}} ">
                      ...
                      <div class="form-group {{$lang->rtl == 1 ? 'text-right' : ''}}">
                        ...
                        <input class="form-control" placeholder="Upload Registration File" type="file" name="filenames[]" id="reg_name" multiple required>
                    </div>
