                              ...
                              <div class="row reorder-xs">
                                  <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                      <div class="product-header-title">
                                          <h2>Upload Prescription <a href="{{ route('user-prescriptions.index') }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a></h2>
                          ...
                          <div>
                            ...
                            <div class="tab-content">
                              ...
                              <div class="tab-pane fade active in" id="digital">
                                <form class="form-horizontal" action="{{route('user-prescriptions.store')}}" method="POST" onsubmit="return validateForm()" enctype="multipart/form-data"  id="form2" >
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      <label class="control-label col-sm-4" for="title">Prescription Order Title*</label>
                                      <div class="col-sm-6">
                                    ...
                                    <div class="form-group" id="file">
                                      ...
                                      <div class="col-sm-6">
                                        ...
                                        <select id="history-prescription" name="fileid[]" class="form-control category-multiple" multiple="multiple" >
                                      ...
                                      <br/> 
                                        ...
                                        <div class="input-group control-group increment text-center" >
            ...
            <div class="modal-body">
              ...
              <form class="form-horizontal" action="{{route('user-family.store')}}" method="POST" id="form2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input class="form-control" name="dob" value="{{ old('dob') }}" placeholder="Dob" required="" type="date" >
                      {{-- @if ($errors->has('age'))
                        <span class="invalid-feedback" role="alert">
