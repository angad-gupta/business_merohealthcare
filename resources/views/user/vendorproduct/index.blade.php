                      ...
                      <div class="add-product-box">
                            ...
                            <div class="row reorder-xs">
                                <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                    <div class="product-header-title">
                                        ...
                                        <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Products <i class="fa fa-angle-right" style="margin: 0 2px;"></i> All Vendor Products</p>
                                    </div>
                                </div>
                        ...
                        <div>
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                            <div class="container">
                              <a href="{{route('user-vendor-product.index')}}" style="margin-bottom: 10px; border-radius:30px;margin-top: 10px;" class="btn btn-default"><i class="fa fa-list" aria-hidden="true"></i> All Products</a>
                              ...
                              <a href="{{route('user-vendor-prod-create')}}" style="margin-bottom: 10px;border-radius:30px;margin-top: 10px;" class="btn btn-success " id=""><i class="fa fa-plus"></i> Add New Product</a>
                              
                              <form class="example pull-right" style="margin-top: 15px;margin-right: 15px; display:flex;" action="{{ route('user-vendor-prod-search')}}">
                                    ...
                                    @foreach($prods as $prod)    
                                        <tr>
                                          ...
                                          <td>   
                                            ...
                                            @if($prod->approval == 0)
                                            <span class="label label-warning" style="border-radius: 30px;padding: 4px 8px;font-size: 12px;"> <i class="fa fa-spinner fa-spin"></i>
                                              <span class="sr-only">Loading...</span> Pending</span> 
                                            @else
                                            <span class="dropdown">
                                          ...
                                          <td>
                                            ...
                                            <a href="{{route('user-vendor-prod-edit',$prod->id)}}" class="btn btn-primary product-btn"><i class="fa fa-edit"></i> Edit</a>
                                            ...
                                            <a href="javascript:;" data-href="{{route('user-vendor-prod-delete',$prod->id)}}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger product-btn"><i class="fa fa-trash"></i></a>
...
$(document).on('click', '#bulk_delete', function(){
  ...
  if(confirm("Are you sure you want to Delete this data?"))
  {
      ...
      {
          $.ajax({
              url:"{{ route('user-vendor-prod-delete-all')}}",
              method:"get",
              data:{id:id},
              success:function(data)
              {
...
$(document).on('click', '#bulk_status', function(){
  ...
  if(confirm("Are you sure you want to change status of these data?"))
  {
      ...
      {
          $.ajax({
              url:"{{ route('user-vendor-prod-multiplestatus')}}",
              method:"get",
              data:{id:id},
              success:function(data)
              {
