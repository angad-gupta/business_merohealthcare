                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="section-padding add-product-1">
                            ...
                            @else
                            {{$conv->sent->name}}
                            @endif <a href="{{ route('user-messages') }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a>
                            </h2>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel panel-primary">
                                            ...
                                            <div class="single-reply-area user">
                                                <div class="row">
                                                    <div class="col-lg-2 col-lg-push-10 col-md-3 col-md-push-9 col-sm-3 col-sm-push-9 col-xs-4 col-xs-push-8">
                                                        <img class="img-circle" src="{{$message->conversation->sent->photo != null ? asset('assets/images/'.$message->conversation->sent->photo) : asset('assets/images/user.png')}}" alt="">
                                            ...
                                            <div class="single-reply-area">
                                                <div class="row">
                                                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                                                        <img class="img-circle" src="{{$message->conversation->recieved->photo != null ? asset('assets/images/'.$message->conversation->recieved->photo) : asset('assets/images/user.png')}}" alt="">
                                      ...
                                      <div class="panel-footer">
                                          <form action="{{route('user-message-post')}}" method="POST">
                                            {{csrf_field()}}
