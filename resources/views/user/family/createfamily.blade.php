                            ...
                            <div class="row reorder-xs">
                                <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                    <div class="product-header-title">
                                        <h2>Create Family <a href="{{ route('user-family.index') }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a></h2>
                                        <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Add Family <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Create
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade active in" id="digital">
                                    <form class="form-horizontal" action="{{route('user-family.store')}}" method="POST" id="form2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                            <input class="form-control" name="firstname" value="" placeholder="First Name" required="" type="text" >
                                            {{-- @if ($errors->has('name'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                            <input class="form-control" name="middlename" value="" placeholder="Middle Name" type="text" >
                                            {{-- @if ($errors->has('name'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('name') }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                            <input class="form-control" name="lastname" value="" placeholder="Last Name" required="" type="text" >
                                            {{-- @if ($errors->has('name'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('name') }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="dob" name="dob" value="" placeholder="YYYY-MM-DD" required=""  >
                                                {{-- @if ($errors->has('age'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('age') }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="relation" value="" placeholder="Relation" required="" type="text">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="phone" value="" placeholder="phone number"  type="text" >
