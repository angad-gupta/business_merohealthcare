                                    ...
                                    <div class="table-responsive">
                                      <table id="product-table_wrapper" class="table table-striped table-hover products dt-responsive" cellspacing="0" width="100%">
                                                    ...
                                                    @foreach($wishes as $prod)
                                                        ...
                                                        <td><a href="{{route('front.product',[$prod->product->id,$prod->product->id ])}}">{{$prod->product->name}}</a></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                @endphp
                                                                <a  target="_blank" href="{{route('front.product',['id1' => $prod->product->id, str_slug($name,'-')])}}" class="btn btn-primary product-btn"><i class="fa fa-eye"></i> View Details</a>
