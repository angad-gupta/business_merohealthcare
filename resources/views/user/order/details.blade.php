...
<main>
                        ...
                        @endif
                            ...
                            <tr>
                                ...
                                <th width="10%">:</th>
                                <td width="45%">{{$order->coupon_discount * $order->currency_value}}</td>
                            </tr>
                            @endif
                                    ...
                                    @if($product['item']['user_id'] == $user->id)
                                        ...
                                        <input type="hidden" value="{{$key}}">
                                                ...
                                                <input type="hidden" value="{{ $product['license'] }}">
                                                    <a target="_blank" href="{{route('front.product',['id1' => $product['item']['id'], str_slug($product['item']['name'],'-')])}}">{{strlen($product['item']['name']) > 30 ? substr($product['item']['name'],0,30).'...' : $product['item']['name']}}</a>
                                                @if($product['license'] != '')
