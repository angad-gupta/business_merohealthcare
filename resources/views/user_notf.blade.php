      @php
        $user_notff = App\Notification::where('user_id','!=',null)->orWhere('vendor_id','!=',null)->orderBy('id','desc')->get();
      ...
      @endphp   
                                                            <div class="profile-wishlist-title">
                                                              ...
                                                              <div class="single-wishlist-area">
                                                               ...
                                                               <div class="single-wishlist-text">
                                                                   <h5><a href="{{route('admin-vendor-show',$notf->vendor_id)}}" style="color: #333;">A User Has applied for Vendor.</a></h5>
                                                                   <p>{{$notf->created_at->diffForHumans()}}</p>
                                                               </div>
                                                              </div>
                                                              @endif
                                                              ...
                                                              <h5><i class="icon-close"></i> No New Notification(s).</h5>
                                                              </div>
                                                              @endif