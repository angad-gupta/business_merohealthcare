  ...
  <div class="col-sm-12">
                    ...
                    @foreach($productt as $prod)
                                                        ...
                                                        <tr>
                                                            ...
                                                            @endphp
                                                            <td><a href="{{route('front.product',['id' => $prod->product->id, 'slug' => str_slug($name,'-')])}}" target="_blank">{{strlen($prod->product->name) > 50 ? substr($prod->product->name, 0, 50) : $prod->product->name}}</a></td>
                                                      <td>
