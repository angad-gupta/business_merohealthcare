                                      ...
                                      <table id="product-table_wrapper" class="table table-striped table-hover products dt-responsive" cellspacing="0" width="100%">
                                              <thead>
                                                  <tr role="row">
                                                    ...
                                                    <th style="width: 285px;">status</th>
                                                      ...
                                                      <td>
                                                        <span class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a href="{{route('admin-adv-status',['id1'=>$ad->id,'id2'=>1])}}">Active</a></li>
                                                                <li><a href="{{route('admin-adv-status',['id1'=>$ad->id,'id2'=>0])}}">Deactive</a></li>
                                                            </ul>
                                                        </span>
                                                      </td>
                                                      <td>
                                                        <a href="{{route('admin-adv-edit',$ad->id)}}" class="btn btn-primary product-btn"><i class="fa fa-edit"></i> Edit</a>
                                                        <a href="javascript:;" data-href="{{route('admin-adv-delete',$ad->id)}}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Remove</a>
                                                      </td>
                                                  </tr>
                                                  @endforeach
                                                  </tbody>
