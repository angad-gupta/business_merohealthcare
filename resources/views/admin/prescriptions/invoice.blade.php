                                        ...
                                        <div class="row reorder-xs">
                                            <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Prescription Details <a href="{{ route('admin-prescription-show',$prescription->id) }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a> </h2>
                                        ...
                                        <div class="order-table-wrap">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-sm-12">
                                                    <form action="{{ route('admin-prescription-invoice',$prescription->id) }}" method="POST">
                                                        {{ csrf_field() }}
                                                            ...
                                                            <table class="table">
                                                                    ...
                                                                    @if($invoice)
                                                                        @foreach ($items as $item)
                                                                            <tr>
                                                                                ...
                                                                                <td>{{ $item['price'] }}</td>
                                                                                <td style="vertical-align: middle;">Rs. {{ $item['qty'] * $item['price'] }}</td>
                                                                            </tr>
                                                                            @php
                                                                    ...
                                                                    @else
                                                                        @forelse ($items as $item)
                                                                            <tr class="item-list-area">
                                                                                ...
                                                                                <td scope="row"><input class="form-control typeahead" name="items[{{ $loop->iteration - 1 }}][name]" id="item-name-{{ $loop->iteration - 1 }}" placeholder="Product Name" type="text" value="{{ $item['name'] }}" autocomplete="off" required></td>
                                                                                <td><textarea rows="1" class="form-control" name="items[{{ $loop->iteration - 1 }}][batch_nos]" id="item-batch-{{ $loop->iteration - 1 }}" placeholder="Separated By ','"></textarea></td>
                                                                                <td><textarea rows="1" class="form-control" name="items[{{ $loop->iteration - 1 }}][exp_dates]" id="item-exp-{{ $loop->iteration - 1 }}" placeholder="Separated By ','"></textarea></td>
                                                                                <td>
                                                                                ...
                                                                                <td width="15%"><input class="form-control toupdate" name="items[{{ $loop->iteration - 1 }}][price]" id="item-price-{{ $loop->iteration - 1 }}" placeholder="Price" type="number" value="{{ $item['price'] }}" min="0" step="0.01" required></td>
                                                                                <td style="vertical-align: middle;">Rs. <span class="item-total" id="item-total-{{ $loop->iteration - 1 }}">{{ $item['qty'] * $item['price'] }}</span></td>
                                                                        ...
                                                                        @empty
                                                                            <tr class="item-list-area">
                                                                                ...
                                                                                <td><input class="form-control toupdate" name="items[0][price]" id="item-price-0" placeholder="Price" type="number" value="0" min="0" step="0.01" required></td>
                                                                ...
                                                                <tfoot>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-xs-right" style="border:0">Rs. <span id="subtotal">{{ $total }}</span></td>
                                                                    </tr>
                                                                    
                                                                    <tr>
                                                                        
                                                                        <td colspan="5" style="text-align: right;vertical-align: middle;border:0" class="text-bold-800">Delivery Fee</td>
                                                                        @if($invoice)
                                                                            <td class=" text-xs-right" style="border:0">Rs. {{ $shipping_cost }}</td>
                                                                        @else
                                                                            <td class=" text-xs-right" style="border:0"> <input class="form-control" type="number"  name="shipping_cost" id="shipping" min="0" value="{{ $shipping_cost }}" /></td>
                                                                        @endif
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-bold-800 text-xs-right" style="border:0"> Rs. <span id="totalAmount">{{ $total + $shipping_cost }}</span></td>
                                                                    </tr>
                                                                </tfoot>
                                                            </table>
