                                        ...
                                        <div class="row represcription-xs">
                                            <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    ...
                                                    <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Lab Prescriptions <i class="fa fa-angle-right" style="margin: 0 2px;"></i> All Lab Prescriptions</p>
                                                </div>
                                            </div>
                                      ...
                                      <table id="product-table_wrapper" class="table table-striped table-hover products dt-responsive" cellspacing="0" width="100%">
                                              ...
                                              <tbody>
                                                @foreach($prescriptions as $prescription)                                                  
                                                    ...
                                                    <tr>
                                                        <td><a href="{{route('admin-prescription-lab-show',$prescription->id)}}">{{sprintf("%'.08d", $prescription->id)}}</a></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{route('admin-prescription-lab-show',$prescription->id)}}" class="btn btn-primary product-btn"><i class="fa fa-check"></i> View Details</a>
