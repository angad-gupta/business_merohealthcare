                      ...
                      <div class="add-product-box">
                        ...
                        <div>
                          ...
                          <div class="container">
                            ...
                            <form class="form-horizontal" action="{{route('admin-career-openings-create-new')}}" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                <div class="col-sm-6"><img style="width: 100%; height: auto;" id="adminimg" src="http://fulldubai.com/SiteImages/noimage.png" alt="" id="adminimg">
                                    </div>
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                    <textarea  type="text" placeholder="Descriptions" id="description" name="description" style="height:200px;width:500px;" ></textarea>
                                    </div>
                                </div>
                                    <hr>
