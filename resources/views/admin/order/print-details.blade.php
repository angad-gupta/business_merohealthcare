...
<html>
  ...
  <body onload="window.print();">
    ...
    <div class="row">
        <div class="col-sm-12" style="margin-top:40px;margin-bottom:0px;">
            <p><strong style="font-size:14px;"> Feedback :</strong> ___________________________________________________________________________________________</p>
        </div>
    </div>
