                                                        ...
                                                        <tbody>
                                                            @foreach($payments as $payment)    
                                                                <tr role="row" class="odd">
                                                                    ...
                                                                    <td>@if($payment->discount_value)
                                                                            {{ $payment->discount_type == 0 ? $payment->discount_value . "%" : $sign->sign . round(($payment->discount_value * $sign->value), 2) }}
                                                                            {{ !$payment->min_purchase_amount ? 'on No min. purchase' : 'on min. purchase of '.$sign->sign . round(($payment->min_purchase_amount * $sign->value), 2) }}
