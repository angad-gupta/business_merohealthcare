                                        ...
                                        <form class="form-horizontal" action="{{route('admin-payment-store')}}" method="POST">
                                          ...
                                          <div id="discountSection"  style="display: none;">
                                            <div class="form-group">
                                              ...
                                              <div class="col-sm-6">
                                                <select class="form-control discountCheck" name="discount_type">
                                            ...
                                            <div class="form-group">
                                              <label class="control-label col-sm-4">Discount Value*</label>
                                              <div class="col-sm-6">
                                                  <input class="form-control discountCheck" name="discount_value" placeholder="Discount Amount/Percentage" type="number" value="" min="1">
                                              </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="col-sm-6">
                                                  <input class="form-control" name="min_purchase_amount" placeholder="Minimum Purchase Amount" type="number" value="" min="1">
