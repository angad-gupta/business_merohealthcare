                                      ...
                                      <tbody class="pricing">
                                        @forelse ($prod->prices as $price)
                                          <tr class="pricing-area">
                                            ...
                                            <td>
                                              <select class="form-control" name="pricings[{{ $loop->iteration-1 }}][type]">
                                            ...
                                            <td width="35%"><input class="form-control" name="pricings[{{ $loop->iteration-1 }}][value]" placeholder="Discount Amount/Percentage" type="number" value="{{ $price->value }}" min="0"></td>
