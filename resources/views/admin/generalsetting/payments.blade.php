                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="disable/enable_about_page">Paypal:</label>
                                            <div class="col-sm-3" style="margin-top: 6px;">
                                                        <span class="dropdown">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="disable/enable_about_page">Stripe:</label>
                                            <div class="col-sm-3" style="margin-top: 6px;">
                                                        <span class="dropdown">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="phone2">Stripe Key  *</label>
                                            <div class="col-sm-6">
                                              <input name="sk" id="phone2" class="form-control" placeholder="Enter Stripe Key" type="text" value="{{$data->sk}}">
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="phone3">Stripe Secret Key  *</label>
                                            <div class="col-sm-6">
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="phone7">VAT(%) *<span>Tax Fee(Inclusive in Product))</span></label>
                                            <div class="col-sm-6">
                                              <input name="vat" id="phone7" class="form-control" placeholder="VAT" type="text" value="{{$data->vat}}" required="">
                                            </div>
                                          </div>

                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="phone7">Health Tax(%) *<span>Tax Fee(Lab Test Price + Tax(%)))</span></label>
                                            <div class="col-sm-6">
                                              <input name="lab_vat" id="phone7" class="form-control" placeholder="Health VAT" type="text" value="{{$data->lab_vat}}" required="">
                                            </div>
                                          </div>

                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="disable/enable_about_page">Multiple Delivery *</label>
                                            <div class="col-sm-3">
                                                <label class="switch">
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="phone8">Delivery Cost *<span>(Total Amount + Delivery Cost)</span></label>
                                            <div class="col-sm-6">
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="">Min Cart Total for Free Delivery<span>(Optional)</span></label>
                                            <div class="col-sm-6">
                                              <input name="min_free_ship" class="form-control" placeholder="Min Price for free Shipping" type="text" value="{{$data->min_free_ship}}">
                                            </div>
                                          </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="disable/enable_about_page">Delivery Information For Vendor *</label>
                                            <div class="col-sm-3">
                                                <label class="switch">
