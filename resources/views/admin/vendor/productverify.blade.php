                                        ...
                                        <div class="row represcription-xs">
                                            <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Product Vendor Verify</h2>
                                                    <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Product Vendor <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Product Vendor Verify</p>
                                                </div>
                                            </div>
                                                    ...
                                                    <td> {{date('d M Y',strtotime($vendor->created_at))}} </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            @foreach((array)$decoded as $d)
                                                                <a href="{{route('admin-product-vendor-reg-file',[$vendor->id,$d])}}" target="_blank"><i class="fa fa-image"></i></a>
                                                            @endforeach
                                                           
                                                        </td>
                                                        <td>
                                                        @if($vendor->verified_at == null)
                                                        <a href="javascript:;" class="btn btn-warning" data-href="{{route('admin-product-vendor-verify',$vendor->id )}}" data-toggle="modal" data-target="#confirm-delete" style="border-radius:30px;">Verify</a>
                                                        @else
