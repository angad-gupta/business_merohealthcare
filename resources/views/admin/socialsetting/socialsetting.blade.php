                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        ...
                                        {{csrf_field()}}
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-sm-3" for="google-Plus">Instagram *</label>
                                            <div class="col-sm-6">
                                              <input class="form-control" name="gplus" id="google-Plus" placeholder="http://instagram.com/" required="" type="text" value="{{$socialdata->gplus}}">
                                            </div>
                                            <div class="col-sm-3">
                                                <label class="switch">
