                                        ...
                                        <form class="form-horizontal" action="{{route('admin-sl-create')}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          {{-- <div class="panel panel-default" style="margin: 20px 20px;">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <textarea class="form-control" name="title" id="edit_language" rows="5" style="resize: vertical;" placeholder="Enter  Title Text" required></textarea>
                                                </div>
                                              </div>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-4">
                                                    ...
                                                    <input class="form-control" type="number" name="title_size" value="" min="1" required>
                                                </div>
                                                  <div class="col-sm-4">
                                              ...
                                              <div class="form-group">
                                                  <div class="col-sm-8 col-sm-offset-2">
                                                    <label class="control-label" for="edit_language">Text*</label>
                                                      ...
                                                      <textarea class="form-control" name="description" id="edit_profile_description" rows="5" style="resize: vertical;" placeholder="Enter  Description" required></textarea>
                                                  </div>
                                              </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6" >
                                             <input type="file" id="uploadFile" name="photo" class="hidden" value="">
                                              ...
                                              <p style="text-align: justify">Prefered Size: (1500x600) or Rectangle Sized Image</p>
                                            </div>
                                          </div>    
