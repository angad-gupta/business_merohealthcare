                ...
                @if($lang->rtl == 1)
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-5">
                        <div class="header-bottom-left-wrap">
                            ...
                            <ul class="hidden-md hidden-lg hidden-sm" id="menucatsData">
                ...
                @else
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-2">
                        <div class="header-search-box text-right">
                            <form action="{{route('front.search')}}" method="GET">
                                <input type="text" class="ss" id="header_search" name="product" placeholder="{{$lang->ec}}" autocomplete="off" required>
                                <button type="submit"><i class="fa fa-search"></i></button>
                            </form>
                        </div>
                        <div class="header-searched-item-list-wrap" style="display: none;">
...
<!-- Starting of Product View Modal -->
<div class="modal fade" id="loginModal" role="dialog" tabindex="-1" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
...
<!-- Starting of Product View Modal -->
<div class="modal fade" id="vendorloginModal" role="dialog" tabindex="-1" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header" style="margin-right:10px;">
...
@if(isset($checked))
    <!-- Starting of Product View Modal -->
    <div class="modal fade" id="checkoutModal"  data-keyboard="false" data-backdrop="static" role="dialog" tabindex="-1" aria-labelledby="myModalLabel">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header" style="margin-right:10px;">
...
@if(isset($vendor))
    @if(Auth::guard('user')->check())
        ...
        <div class="modal vendor" id="emailModal" tabindex="-1" role="dialog"  tabindex="-1" aria-labelledby="myModalLabel">
...
<script>
    ...
    $(document).on("click", "#product_email" , function(){
        ...
        $(".show_hide").on("click", function (e) {
            e.preventDefault();
            var txt = $(".content").is(':visible') ? '{{$lang->see_more}}' : '{{$lang->see_less}}';
            $(".show_hide").text(txt);
            $('.content').toggle();
        });
