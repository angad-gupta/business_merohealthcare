...
{{$curr->sign}}
                            ...
                            @endif
                            @else                  
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12" style="width:50%;" style="width:50%;" data-animation="zoomIn" data-animation-delay="0" data-animation-duration="1000">
                                      @php
                                          $name = str_replace(" ","-",$prod->name);
                                      @endphp
                        <div class="single-product-area text-center" style="margin-bottom:0px;">
...
<div class="product-hover-area">
                    ...
                    <span class="wish-list hovertip wish-listt" data-toggle="modal" data-target="#myModal" rel-toggle="tooltip" title="{{$lang->quick_view}}"><i class="fa fa-eye"></i>
                        ...
                        <div class="product-description single-product-area text-center" style="margin-top:0px;">
                            <div class="product-name" style="margin-bottom: 35px;"> <a href="{{route('front.product',['id' => $prod->id, 'slug' => str_slug($name,'-')])}}" class="text-center">{{strlen($prod->name) > 38 ? substr($prod->name,0,38)."..." : $prod->name}}</a></div>
                            {{-- <div class="product-review">
                                                  <div class="ratings">
                                                      <div class="empty-stars"></div>
                                                      <div class="full-stars" style="width:{{App\Review::ratings($prod->id)}}%"></div>
