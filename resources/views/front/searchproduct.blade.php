    ...
    <div class="section-padding product-category-wrap">
        <div class="container">
            <div class="row">
                ...
                <h2 class="text-center h4" style="font-weight:300"><i class="icon-magnifier"></i> Search Result For : <strong style="font-weight:700">{{$search}}</strong></h2> 
                <p class="text-center" style="font-size:14px;color:#28a745 ">({{count($sproducts_count)}} Product(s) Found ! )</p>
                <br/>
                    <div class="category-wrap">
                        <div class="row">
                @forelse($sproducts as $prod)
                  @php
                  ...
                  @endphp
                      ...
                      @if($prod->user->is_vendor == 3)
                        ...
                        @endphp
                            ...
                            <div class="product-description single-product-area text-center" style="margin-top:0px;">
                                <div class="product-name" style="margin-bottom: 0px;"> <a href="{{route('front.product',['id' => $prod->id, 'slug' => str_slug($name,'-')])}}" class="text-center">{{strlen($prod->name) > 38 ? substr(ucwords(strtolower($prod->name)),0,38)."..." : ucwords(strtolower($prod->name))}}</a></div>
                            {{-- <div class="product-review">
                                    ...
                                    @else
                                        ...
                                        @if($prod->pprice != null && $prod->pprice != 0  && $prod->pprice > $prod->cprice)
                                          @php
                                            $pprice = $prod->pprice + $gs->fixed_commission + ($pprice/100) * $gs->percentage_commission ;
                                          @endphp 
                            ...
                            <div id="card" class="col-lg-3 col-md-6 col-sm-6 col-xs-12" style="width:50%;" data-animation="zoomIn" data-animation-delay="0" data-animation-duration="1000">
             ...
             <span class="wish-list hovertip wish-listt" data-toggle="modal" data-target="#myModal" rel-toggle="tooltip" title="{{$lang->quick_view}}"><i class="fa fa-eye"></i>
                 ...
                 <div class="product-description single-product-area text-center" style="margin-top:0px;">
                     <div class="product-name" style="margin-bottom: 15px;"> <a href="{{route('front.product',['id' => $prod->id, 'slug' => str_slug($name,'-')])}}" class="text-center">{{strlen($prod->name) > 38 ? substr(ucwords(strtolower($prod->name)),0,38)."..." : ucwords(strtolower($prod->name))}}</a>
