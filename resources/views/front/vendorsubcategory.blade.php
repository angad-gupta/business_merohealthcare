...
<div class="product-hover-area">
                    ...
                    @php
                                                    ...
                                                    @endphp 
                      <span style="display:inline; font-size:12px"><del class="offer-price">{{$curr->sign}}{{round($pprice * $curr->value,2)}}</del> -{{ $prod->discount_percent }}%</span>  
                      @endif
...
<div class="product-hover-area">
                    ...
                    @if($prod->pprice != null && $prod->pprice != 0  && $prod->pprice > $prod->cprice)
                      <span style="display:inline; font-size:12px"><del class="offer-price">{{$curr->sign}}{{round($prod->pprice * $curr->value,2)}}</del> -{{ $prod->discount_percent }}%</span>  
                      @endif
                ...
                @if(isset($min) || isset($max))
                    <div class="row">
                        <div class="col-md-12 text-center"> 
                            {!! $vsubcats->appends(['min' => $min, 'max' => $max])->links() !!}               
                        </div>
                    </div>
                @else
                    <div class="row">
...
<script type="text/javascript">
        ...
        var sort = $("#sortby").val();
        window.location = "{{url('/vendor')}}/{{str_replace(' ', '-',($vendor->shop_name))}}/subcategory/{{$vsubcat->sub_slug}}/"+sort;
    });
</script>
