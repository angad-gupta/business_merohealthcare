...
.mlpm_w .ltr {
  margin-left: -100%;
  left: 0;
  -moz-box-shadow: 5px 0 5px -5px #b01013;
  -webkit-box-shadow: 5px 0 5px -5px #b01013;
  box-shadow: 5px 0 5px -5px #b01013;
...
.mlpm_w .backItemClass {
  display: block;
  padding: 0.7em 0.4em 0.7em 12px;
  background: #ba0011;
  border-top: 1px solid #b01013;
  text-transform: uppercase;
  font-size: 11px;
...
<div id="page">
    <div class="header">
      ...
      <a id="toggle-button" class="btn btn-lg btn-primary" href="#" role="button"><i class="fa fa-bars"></i></a><br><br>
    </div>
  <br>
  <div id="menu">
    <nav>
      <h2><i class="fa fa-times fa-fw"></i><span>Navigation</span></h2>
      <ul>
        <li class="menu-item">
          <a href="#"><i class="fa fa-home fa-fw"></i>Home Security</a>
          <h2><a href="#"><i class="fa fa-laptop fa-fw"></i><span>Home Security</span></a></h2>
          <ul>
            <li class="menu-item">
              <a href="#"><i class="fa fa-phone fa-fw"></i>Home Security Features</a>
              <h2><a href="#"><i class="fa fa-phone"></i><span>Home Security Features</span></a></h2>
              <ul>
                <li class="menu-item">
            ...
            <li>
              <a href="#"><i class="fa fa-desktop fa-fw"></i>Home Solutions</a>
              <h2><i class="fa fa-desktop fa-fw"></i>Home Solutions</h2>
              <ul>
                <li>
                  <a href="#">Solution</a>
                </li>
            ...
            <li>
              <a href="#"><i class="fa fa-camera-retro fa-fw"></i>Learning Center</a>
              <h2><i class="fa fa-camera-retro fa-fw"></i>Learning Center</h2>
              <ul>
                <li>
                  <a href="#">Smart Shot</a>
                </li>
        ...
        <li class="menu-item">
          <a href="#"><i class="fa fa-building fa-fw"></i>Business Security</a>
          <h2><i class="fa fa-book fa-fw"></i>Business Security</h2>
          <ul>
            <li class="menu-item">
        ...
        <li class="menu-item">
          <a href="#"><i class="fa fa-shopping-cart fa-fw"></i>Compare</a>
          <h2><i class="fa fa-shopping-cart fa-fw"></i>Compare</h2>
          <ul>
            <li class="menu-item">
              <a href="#"><i class="fa fa-tags fa-fw"></i>Clothes</a>
              <h2><i class="fa fa-tags fa-fw"></i>Clothes</h2>
              <ul>
                <li>
                  <a href="#"><i class="fa fa-female fa-fw"></i>Women's Clothing</a>
                  <h2><i class="fa fa-female fa-fw"></i>Women's Clothing</h2>
                  <ul>
                    <li>
                      <a href="#">Tops</a>
                    </li>
        ...
        <li class="menu-item">
          <a href="#"><i class="fa fa-truck fa-fw"></i>Moving?</a>
        </li>
        <li class="small-link small-link-top menu-item">
          <a href="#">Blog</a>
        </li>
        <li class="small-link menu-item">
          <a href="#">Contact</a>
        </li>
        <li class="small-link menu-item">
          <a href="#">Login</a>
